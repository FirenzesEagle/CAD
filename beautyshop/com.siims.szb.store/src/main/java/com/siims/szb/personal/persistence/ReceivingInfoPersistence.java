...
/**   
 * @Title: ReceivingInfoPersistence.java 
 * @Package: com.siims.szb.demo.persistence 
 * @Description: 收货信息持久化层接口
 * @author liumingbo 
 * @date 2015年9月14日 下午3:47:43 
 * @version 0.1
 */
...
public interface ReceivingInfoPersistence extends BasePersistence<ReceivingInfoData> {
