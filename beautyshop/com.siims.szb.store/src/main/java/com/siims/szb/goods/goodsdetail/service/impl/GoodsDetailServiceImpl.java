...
public class GoodsDetailServiceImpl implements GoodsDetailService{
	...
	public List<DetailInfoData> searchAllDetailInfo(String goodsId) {
		// TODO Auto-generated method stub
		return ServiceContext.get(GoodsDetailBusiness.class).searchAllDetailInfo(goodsId);
	}
	...
	public List<DetailInfoData> searchDetailInfoByGoodsConfigId(String goodsConfigId) {
		// TODO Auto-generated method stub
		return ServiceContext.get(GoodsDetailBusiness.class).searchDetailInfoByGoodsConfigId(goodsConfigId);
	}
