...
<title>编辑商品</title>
<link type="text/css" rel="stylesheet" href="/wro/szb.lf.editgoods.css" />
</head>
                ...
                <div class="desp">
 					...
 					<div class="description">
                		<label class="b1"><b class="b11"></b>&nbsp;描述图片：</label><img class="imgTwo1" name="goodspics" src="/wro/wroResources?id=classpath:ui/image/null.png" id="file_up2"/><button class="b3" id="file_up2">上传描述图片</button><input type="file" onchange="preImg(this.id)" accept="image/jpeg,image/png" class="file2" name="uploadImg" id="imgTwo1" /><br /><br />
               			<label class="c1"><b></b>&nbsp;描述信息：</label><textarea class="c2 goodsdescription" id="1" name="0"></textarea><button class="c4" id="1">删除该条</button><br /><br /><hr />
                		<br />
                	</div>		
                </div>
                
                <center><button class="c3">继续添加图文</button>&nbsp;<button class="view">预览</button>&nbsp;<button class="submit">修改</button></center>
            </div>
  </div>  
</body>
<script type="text/javascript" src="/wro/szb.jquery.js" ></script>

	<script type="text/javascript" src="/wro/szb.lf.editgoods.js" ></script>
