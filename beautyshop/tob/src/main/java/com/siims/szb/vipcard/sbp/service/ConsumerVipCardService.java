...
/**
 * 服务于ConsumerVipCardData的Service层
 * @author libo
 * 2015-09-14
 */
public interface ConsumerVipCardService extends BaseService {
	
	/**
	 * 添加一条记录，返回插入的ID
	 * @author libo
	 * 2015-09-14
	 * @param String typeId, String configId, String openid, String name, String phone, String password, double lastmoney
	 */
	public String addConsumerVipCardData(String typeId, String configId, String openid, String name, String phone, String password, double lastmoney);
